...
import com.swatiag1101.sunshine_new.data.WeatherContract.WeatherEntry;
import com.swatiag1101.sunshine_new.data.WeatherDbHelper;
import com.swatiag1101.sunshine_new.data.WeatherProvider;
   ...
   // , ArrayAdapter<String> forecastAdapter
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.temp),
                mContext.getString(R.string.temp_default));

        if (!unitType.equals(mContext.getString(R.string.temp_default))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.temp_default)) && !unitType.equals("Imperial")) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(cursor.moveToFirst()){
            ...
            id = cursor.getLong(locationIndex);
            //Log.v("ID",id+"");
        }else {
...
//
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            final String appid_val = "2de143494c0b295cca9337e1e96b00e0";
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(appid,appid_val)
                    .build();
